    ...
    $("#uploadform").on('submit', function(e) {
        ...
        createVideo(vname, function(res, err) {
            ...
            $.ajax({
                ...
                //url:'http://127.0.0.1:9006/upload/dbibi',
                type : 'POST',
                data : formData,
...
function getUserId(callback) {
    var dat = {
        'url': 'http://' + window.location.hostname + ':9003/user/' + uname,
        'method': 'GET'
    };
...
function createVideo(vname, callback) {
    ...
    var dat = {
        'url': 'http://' + window.location.hostname + ':9003/user/' + uname + '/videos',
        'method': 'POST',
        'req_body': JSON.stringify(reqBody)
    };
...
function deleteVideo(vid, callback) {
    var dat = {
        'url': 'http://' + window.location.hostname + ':9003/user/' + uname + '/videos/' + vid,
        'method': 'DELETE',
        'req_body': ''
    };
...
function postComment(vid, content, callback) {
    ...
    var dat = {
        'url': 'http://' + window.location.hostname + ':9003/videos/' + vid + '/comments',
        'method': 'POST',
        'req_body': JSON.stringify(reqBody)
    };
